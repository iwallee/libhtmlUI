...
// These are indexed by WebThemeControlImpl::State, *not* WebThemeEngine::State.
    ...
    SkIRect validate(const SkIRect& rect, WebThemeControlImpl::Type ctype)
    {
        switch (ctype) {
        case WebThemeControlImpl::UncheckedBoxType:
        case WebThemeControlImpl::CheckedBoxType:
        case WebThemeControlImpl::UncheckedRadioType:
        case WebThemeControlImpl::CheckedRadioType: {
            SkIRect retval = rect;
...
WebThemeControlImpl::WebThemeControlImpl(SkCanvas* canvas, const SkIRect& irect, Type ctype, State cstate)
    : m_canvas(canvas)
...
WebThemeControlImpl::~WebThemeControlImpl()
{
}

void WebThemeControlImpl::box(const SkIRect& rect, SkColor fillColor)
{
    SkPaint paint;
...
void WebThemeControlImpl::line(int x0, int y0, int x1, int y1, SkColor color)
{
    SkPaint paint;
...
void WebThemeControlImpl::triangle(int x0, int y0, int x1, int y1, int x2, int y2, SkColor color)
{
    SkPath path;
    SkPaint paint;
...
void WebThemeControlImpl::roundRect(SkColor color)
{
    SkRect rect;
...
void WebThemeControlImpl::oval(SkColor color)
{
    SkRect rect;
    SkPaint paint;
...
void WebThemeControlImpl::circle(SkScalar radius, SkColor color)
{
...
void WebThemeControlImpl::nestedBoxes(int indentLeft, int indentTop, int indentRight, int indentBottom, SkColor outerColor, SkColor innerColor)
{
    SkIRect lirect;
...
void WebThemeControlImpl::markState()
{
...
void WebThemeControlImpl::drawTextField(bool drawEdges, bool fillContentArea, SkColor color)
{
    SkPaint paint;
...
void WebThemeControlImpl::drawProgressBar(const SkIRect& fillRect)
{
    SkPaint paint;
